...
public interface ChangeMapper {
    ...
    ChangeEntity eventOutDtoToChange(EventOutDto eventOutDto);
    ...
    EventOutDto changeToEventOutDto(ChangeEntity changeEntity);

    List<EventOutDto> changeListToEventOutDtoList(List<ChangeEntity> changeEntities);
}
